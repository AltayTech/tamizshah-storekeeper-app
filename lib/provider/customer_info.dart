...
class CustomerInfo with ChangeNotifier {
  ...
  static Operator _customer_zero = Operator(
  ...
  Operator _operator = _customer_zero;
  String _token;
  ...
  Future<void> getCustomer() async {
    ...
    final url = Urls.rootUrl + Urls.operatorEndPoint;
    print(url);
    ...
    try {
      ...
      operator = Operator.fromJson(extractedData);
  ...
  Operator get driver_zero => _customer_zero;

...
class DeliveryDetailItem extends StatefulWidget {
  ...
  @override
  _DeliveryDetailItemState createState() => _DeliveryDetailItemState();
}

class _DeliveryDetailItemState extends State<DeliveryDetailItem> {
  bool _isInit = true;
...
//          widget.wasteItem.weight);
  ...
  Future<void> removeItem() async {
    ...
    await Provider.of<Deliveries>(context, listen: false).removeWasteCart(
                            ...
                            Expanded(
                              ...
                              onTap: () async {
                                if (!widget.isCollected) {
                                  ...
                                  await Provider.of<Deliveries>(context,
                                          listen: false)
                                      .updateWasteCart(
                                          widget.wasteItem,
                              ...
                              child: InkWell(
                                onTap: () {
                                  if (!widget.isCollected) {
                                    ...
                                    Provider.of<Deliveries>(context,
                                            listen: false)
                                        .updateWasteCart(
                                            widget.wasteItem,
                                            getWeight(productWeight,
